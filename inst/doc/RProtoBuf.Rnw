...
de-serialization as well data and configuration management. Performance
buffers are also forward compatible: updates the to proto files do not
break programs built against the previous specification.
