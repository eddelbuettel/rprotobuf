...
\texttt{add} & \label{protobufMessage-method-add} & add elements to a repeated field \\
\hline
...
\texttt{fileDescriptor} & \ref{protobufMessage-method-fileDescriptor} & get the file descriptor 
...
\subsubsection{protobufMessage\$add method}
\label{protobufMessage-method-add}
...
\subsubsection{protobufMessage\$fileDescriptor method}
\label{protobufMessage-method-fileDescriptor}
