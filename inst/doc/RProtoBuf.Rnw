...
\href{http://en.wikipedia.org/wiki/Interface_description_language}{Interface
  Description Languages (IDL)}. This consists of
compiling a protocol buffer description file (ending in \texttt{.proto}) into
